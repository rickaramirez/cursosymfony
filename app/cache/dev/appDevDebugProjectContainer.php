...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'system_configuration' => 'getSystemConfigurationService',
            ...
            'user_profile_provider' => 'getUserProfileProviderService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.main' => 'security.user_checker.secured_area',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'product_shop', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Products/ProductBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Users/UsersBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Products\\ProductBundle\\Entity');
        $c->addDriver($b, 'Users\\UsersBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('ProductsProductBundle' => 'Products\\ProductBundle\\Entity', 'UsersUsersBundle' => 'Users\\UsersBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4ed63a9737ca2ab1936dd1ef3833f3d7fecf2dd05b81515d657d84cb6aa48acb');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.main' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/products'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        ...
        $h->setOptions(array('login_path' => 'login', 'default_target_path' => '/products', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $h, $i, array('check_path' => 'loguin_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '56e4641b17e6d9.60019372', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'login', false), NULL, NULL, $b, false));
    }
    ...
    /**
     * Gets the 'system_configuration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Utilities\ConfigurationBundle\Controller\ConfigurationController A Utilities\ConfigurationBundle\Controller\ConfigurationController instance.
     */
    protected function getSystemConfigurationService()
    {
        return $this->services['system_configuration'] = new \Utilities\ConfigurationBundle\Controller\ConfigurationController();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Products/ProductBundle/Resources/views'), 'ProductsProduct');
        $instance->addPath(($this->targetDirs[3].'/src/Users/SecurityBundle/Resources/views'), 'UsersSecurity');
        $instance->addPath(($this->targetDirs[3].'/src/Users/UsersBundle/Resources/views'), 'UsersUsers');
        $instance->addPath(($this->targetDirs[3].'/src/Utilities/ConfigurationBundle/Resources/views'), 'UtilitiesConfiguration');
    ...
    /**
     * Gets the 'user_profile_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Users\UserBundle\Entity\UserProvider A Users\UserBundle\Entity\UserProvider instance.
     */
    protected function getUserProfileProviderService()
    {
        return $this->services['user_profile_provider'] = new \Users\UserBundle\Entity\UserProvider($this->get('doctrine'), $this);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProductsProductBundle' => 'Products\\ProductBundle\\ProductsProductBundle',
                'UsersSecurityBundle' => 'Users\\SecurityBundle\\UsersSecurityBundle',
                'UsersUsersBundle' => 'Users\\UsersBundle\\UsersUsersBundle',
                'UtilitiesConfigurationBundle' => 'Utilities\\ConfigurationBundle\\UtilitiesConfigurationBundle',
